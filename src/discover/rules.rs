...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^bun\s+(run|install|add|remove|update|build|test)",
        rtk_cmd: "rtk bun",
    ...
    RtkRule {
        pattern: r"^(npx\s+|pnpm\s+|bunx\s+)?(eslint|biome|lint)(\s|$)",
        rtk_cmd: "rtk lint",
        rewrite_prefixes: &[
            "npx eslint",
            "pnpm lint",
    ...
    RtkRule {
        pattern: r"^(npx\s+|pnpm\s+|bunx\s+)?prettier",
        rtk_cmd: "rtk prettier",
        rewrite_prefixes: &["npx prettier", "pnpm prettier", "bunx prettier", "prettier"],
        category: "Build",
        savings_pct: 70.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^(npx\s+|pnpm\s+|bunx\s+)?next\s+build",
        rtk_cmd: "rtk next",
        rewrite_prefixes: &["npx next build", "pnpm next build", "bunx next build", "next build"],
        category: "Build",
        savings_pct: 87.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^(pnpm\s+|npx\s+|bunx\s+)?(vitest|jest|test)(\s|$)",
        rtk_cmd: "rtk vitest",
        rewrite_prefixes: &["pnpm vitest", "npx vitest", "bunx vitest", "vitest", "jest"],
        category: "Tests",
        savings_pct: 99.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^(npx\s+|pnpm\s+|bunx\s+)?playwright",
        rtk_cmd: "rtk playwright",
        rewrite_prefixes: &["npx playwright", "pnpm playwright", "bunx playwright", "playwright"],
        category: "Tests",
        savings_pct: 94.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^(npx\s+|pnpm\s+|bunx\s+)?prisma",
        rtk_cmd: "rtk prisma",
        rewrite_prefixes: &["npx prisma", "pnpm prisma", "bunx prisma", "prisma"],
        category: "Build",
        savings_pct: 88.0,
        subcmd_savings: &[],
        subcmd_status: &[],
